...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 18 2023 г., 18:28
...
--
-- Структура таблицы `jumla_action_logs`
--

CREATE TABLE `jumla_action_logs` (
...
--
-- Структура таблицы `jumla_action_logs_extensions`
--

CREATE TABLE `jumla_action_logs_extensions` (
  `id` int(10) UNSIGNED NOT NULL,
  `extension` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `jumla_action_logs_extensions`
--

INSERT INTO `jumla_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Структура таблицы `jumla_action_logs_users`
--

CREATE TABLE `jumla_action_logs_users` (
...
--
-- Структура таблицы `jumla_action_log_config`
--

CREATE TABLE `jumla_action_log_config` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Дамп данных таблицы `jumla_action_log_config`
--

INSERT INTO `jumla_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Структура таблицы `jumla_assets`
--

CREATE TABLE `jumla_assets` (
...
--
-- Дамп данных таблицы `jumla_assets`
--

INSERT INTO `jumla_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Структура таблицы `jumla_associations`
--

CREATE TABLE `jumla_associations` (
...
--
-- Структура таблицы `jumla_banners`
--

CREATE TABLE `jumla_banners` (
  `id` int(11) NOT NULL,
...
--
-- Структура таблицы `jumla_banner_clients`
--

CREATE TABLE `jumla_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Структура таблицы `jumla_banner_tracks`
--

CREATE TABLE `jumla_banner_tracks` (
...
--
-- Структура таблицы `jumla_categories`
--

CREATE TABLE `jumla_categories` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `jumla_categories`
--

INSERT INTO `jumla_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 431, '2023-06-18 14:47:47', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 431, '2023-06-18 14:47:47', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 431, '2023-06-18 14:47:47', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 431, '2023-06-18 14:47:47', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 431, '2023-06-18 14:47:47', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 431, '2023-06-18 14:47:47', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Структура таблицы `jumla_contact_details`
--

CREATE TABLE `jumla_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Структура таблицы `jumla_content`
--

CREATE TABLE `jumla_content` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Структура таблицы `jumla_contentitem_tag_map`
--

CREATE TABLE `jumla_contentitem_tag_map` (
  `type_alias` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Структура таблицы `jumla_content_frontpage`
--

CREATE TABLE `jumla_content_frontpage` (
...
--
-- Структура таблицы `jumla_content_rating`
--

CREATE TABLE `jumla_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `jumla_content_types`
--

CREATE TABLE `jumla_content_types` (
...
--
-- Дамп данных таблицы `jumla_content_types`
--

INSERT INTO `jumla_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Структура таблицы `jumla_core_log_searches`
--

CREATE TABLE `jumla_core_log_searches` (
...
--
-- Структура таблицы `jumla_extensions`
--

CREATE TABLE `jumla_extensions` (
...
--
-- Дамп данных таблицы `jumla_extensions`
--

INSERT INTO `jumla_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{\"name\":\"LIB_JOOMLA\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2008 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}', '{\"mediaversion\":\"8af61075c9541680fb2b71f52d8be50e\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2015 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1687099725}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Структура таблицы `jumla_fields`
--

CREATE TABLE `jumla_fields` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `jumla_fields_categories`
--

CREATE TABLE `jumla_fields_categories` (
...
--
-- Структура таблицы `jumla_fields_groups`
--

CREATE TABLE `jumla_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Структура таблицы `jumla_fields_values`
--

CREATE TABLE `jumla_fields_values` (
...
--
-- Структура таблицы `jumla_finder_filters`
--

CREATE TABLE `jumla_finder_filters` (
...
--
-- Структура таблицы `jumla_finder_links`
--

CREATE TABLE `jumla_finder_links` (
...
--
-- Структура таблицы `jumla_finder_links_terms0`
--

CREATE TABLE `jumla_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `jumla_finder_links_terms1`
--

CREATE TABLE `jumla_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `jumla_finder_links_terms2`
--

CREATE TABLE `jumla_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `jumla_finder_links_terms3`
--

CREATE TABLE `jumla_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `jumla_finder_links_terms4`
--

CREATE TABLE `jumla_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `jumla_finder_links_terms5`
--

CREATE TABLE `jumla_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `jumla_finder_links_terms6`
--

CREATE TABLE `jumla_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `jumla_finder_links_terms7`
--

CREATE TABLE `jumla_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `jumla_finder_links_terms8`
--

CREATE TABLE `jumla_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `jumla_finder_links_terms9`
--

CREATE TABLE `jumla_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `jumla_finder_links_termsa`
--

CREATE TABLE `jumla_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `jumla_finder_links_termsb`
--

CREATE TABLE `jumla_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `jumla_finder_links_termsc`
--

CREATE TABLE `jumla_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `jumla_finder_links_termsd`
--

CREATE TABLE `jumla_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `jumla_finder_links_termse`
--

CREATE TABLE `jumla_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `jumla_finder_links_termsf`
--

CREATE TABLE `jumla_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `jumla_finder_taxonomy`
--

CREATE TABLE `jumla_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Дамп данных таблицы `jumla_finder_taxonomy`
--

INSERT INTO `jumla_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `jumla_finder_taxonomy_map`
--

CREATE TABLE `jumla_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `jumla_finder_terms`
--

CREATE TABLE `jumla_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `jumla_finder_terms_common`
--

CREATE TABLE `jumla_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Дамп данных таблицы `jumla_finder_terms_common`
--

INSERT INTO `jumla_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Структура таблицы `jumla_finder_tokens`
--

CREATE TABLE `jumla_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(3) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(3) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `jumla_finder_tokens_aggregate`
--

CREATE TABLE `jumla_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `jumla_finder_types`
--

CREATE TABLE `jumla_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `jumla_languages`
--

CREATE TABLE `jumla_languages` (
...
--
-- Дамп данных таблицы `jumla_languages`
--

INSERT INTO `jumla_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Структура таблицы `jumla_menu`
--

CREATE TABLE `jumla_menu` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `jumla_menu`
--

INSERT INTO `jumla_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Структура таблицы `jumla_menu_types`
--

CREATE TABLE `jumla_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы `jumla_menu_types`
--

INSERT INTO `jumla_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `jumla_messages`
--

CREATE TABLE `jumla_messages` (
...
--
-- Структура таблицы `jumla_messages_cfg`
--

CREATE TABLE `jumla_messages_cfg` (
...
--
-- Структура таблицы `jumla_modules`
--

CREATE TABLE `jumla_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Дамп данных таблицы `jumla_modules`
--

INSERT INTO `jumla_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Структура таблицы `jumla_modules_menu`
--

CREATE TABLE `jumla_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `jumla_modules_menu`
--

INSERT INTO `jumla_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Структура таблицы `jumla_newsfeeds`
--

CREATE TABLE `jumla_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `jumla_overrider`
--

CREATE TABLE `jumla_overrider` (
...
--
-- Структура таблицы `jumla_postinstall_messages`
--

CREATE TABLE `jumla_postinstall_messages` (
...
--
-- Дамп данных таблицы `jumla_postinstall_messages`
--

INSERT INTO `jumla_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Структура таблицы `jumla_privacy_consents`
--

CREATE TABLE `jumla_privacy_consents` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `jumla_privacy_requests`
--

CREATE TABLE `jumla_privacy_requests` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `jumla_redirect_links`
--

CREATE TABLE `jumla_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `jumla_schemas`
--

CREATE TABLE `jumla_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `jumla_schemas`
--

INSERT INTO `jumla_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.10.7-2022-03-18');

-- --------------------------------------------------------

--
-- Структура таблицы `jumla_session`
--

CREATE TABLE `jumla_session` (
...
--
-- Дамп данных таблицы `jumla_session`
--

INSERT INTO `jumla_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
(0x33656667316f70386e716f6d30366f3170396f67346672736676386a32627268, 1, 1, 1687099729, 'joomla|s:736:\"\";', 0, ''),
(0x743673316f703168383535366476646b756661707030726e707132726a643237, 0, 1, 1687101415, 'joomla|s:736:\"\";', 0, '');

-- --------------------------------------------------------

--
-- Структура таблицы `jumla_tags`
--

CREATE TABLE `jumla_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы `jumla_tags`
--

INSERT INTO `jumla_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 431, '2023-06-18 14:47:47', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Структура таблицы `jumla_template_styles`
--

CREATE TABLE `jumla_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Дамп данных таблицы `jumla_template_styles`
--

INSERT INTO `jumla_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `inheritable`, `parent`, `params`) VALUES
...
--
-- Структура таблицы `jumla_ucm_base`
--

CREATE TABLE `jumla_ucm_base` (
...
--
-- Структура таблицы `jumla_ucm_content`
--

CREATE TABLE `jumla_ucm_content` (
...
--
-- Структура таблицы `jumla_ucm_history`
--

CREATE TABLE `jumla_ucm_history` (
...
--
-- Структура таблицы `jumla_updates`
--

CREATE TABLE `jumla_updates` (
...
--
-- Структура таблицы `jumla_update_sites`
--

CREATE TABLE `jumla_update_sites` (
...
--
-- Дамп данных таблицы `jumla_update_sites`
--

INSERT INTO `jumla_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1687099726, ''),
...
--
-- Структура таблицы `jumla_update_sites_extensions`
--

CREATE TABLE `jumla_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Дамп данных таблицы `jumla_update_sites_extensions`
--

INSERT INTO `jumla_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 802),
(3, 28);
...
--
-- Структура таблицы `jumla_usergroups`
--

CREATE TABLE `jumla_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Дамп данных таблицы `jumla_usergroups`
--

INSERT INTO `jumla_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Структура таблицы `jumla_users`
--

CREATE TABLE `jumla_users` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `jumla_users`
--

INSERT INTO `jumla_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`, `authProvider`) VALUES
(431, 'Super User', 'admin', 'admin@jumla.ru', '$2y$10$a/L8eWt87NkUxa/1GRfnluy8fD2pAPYqnwoscLgf5xKPCaAIAhEa6', 0, 1, '2023-06-18 14:47:48', '0000-00-00 00:00:00', '0', '', '0000-00-00 00:00:00', 0, '', '', 0, '');

-- --------------------------------------------------------

--
-- Структура таблицы `jumla_user_keys`
--

CREATE TABLE `jumla_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `jumla_user_notes`
--

CREATE TABLE `jumla_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `jumla_user_profiles`
--

CREATE TABLE `jumla_user_profiles` (
...
--
-- Структура таблицы `jumla_user_usergroup_map`
--

CREATE TABLE `jumla_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `jumla_user_usergroup_map`
--

INSERT INTO `jumla_user_usergroup_map` (`user_id`, `group_id`) VALUES
(431, 8);

-- --------------------------------------------------------

--
-- Структура таблицы `jumla_utf8_conversion`
--

CREATE TABLE `jumla_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `jumla_utf8_conversion`
--

INSERT INTO `jumla_utf8_conversion` (`converted`) VALUES
(5);

-- --------------------------------------------------------

--
-- Структура таблицы `jumla_viewlevels`
--

CREATE TABLE `jumla_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Дамп данных таблицы `jumla_viewlevels`
--

INSERT INTO `jumla_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Индексы таблицы `jumla_action_logs`
--
ALTER TABLE `jumla_action_logs`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `jumla_action_logs_extensions`
--
ALTER TABLE `jumla_action_logs_extensions`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `jumla_action_logs_users`
--
ALTER TABLE `jumla_action_logs_users`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_notify` (`notify`);

--
-- Индексы таблицы `jumla_action_log_config`
--
ALTER TABLE `jumla_action_log_config`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `jumla_assets`
--
ALTER TABLE `jumla_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `jumla_associations`
--
ALTER TABLE `jumla_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Индексы таблицы `jumla_banners`
--
ALTER TABLE `jumla_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `jumla_banner_clients`
--
ALTER TABLE `jumla_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Индексы таблицы `jumla_banner_tracks`
--
ALTER TABLE `jumla_banner_tracks`
...
--
-- Индексы таблицы `jumla_categories`
--
ALTER TABLE `jumla_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `jumla_contact_details`
--
ALTER TABLE `jumla_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Индексы таблицы `jumla_content`
--
ALTER TABLE `jumla_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Индексы таблицы `jumla_contentitem_tag_map`
--
ALTER TABLE `jumla_contentitem_tag_map`
...
--
-- Индексы таблицы `jumla_content_frontpage`
--
ALTER TABLE `jumla_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Индексы таблицы `jumla_content_rating`
--
ALTER TABLE `jumla_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Индексы таблицы `jumla_content_types`
--
ALTER TABLE `jumla_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Индексы таблицы `jumla_extensions`
--
ALTER TABLE `jumla_extensions`
...
--
-- Индексы таблицы `jumla_fields`
--
ALTER TABLE `jumla_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Индексы таблицы `jumla_fields_categories`
--
ALTER TABLE `jumla_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Индексы таблицы `jumla_fields_groups`
--
ALTER TABLE `jumla_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Индексы таблицы `jumla_fields_values`
--
ALTER TABLE `jumla_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Индексы таблицы `jumla_finder_filters`
--
ALTER TABLE `jumla_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Индексы таблицы `jumla_finder_links`
--
ALTER TABLE `jumla_finder_links`
...
--
-- Индексы таблицы `jumla_finder_links_terms0`
--
ALTER TABLE `jumla_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `jumla_finder_links_terms1`
--
ALTER TABLE `jumla_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `jumla_finder_links_terms2`
--
ALTER TABLE `jumla_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `jumla_finder_links_terms3`
--
ALTER TABLE `jumla_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `jumla_finder_links_terms4`
--
ALTER TABLE `jumla_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `jumla_finder_links_terms5`
--
ALTER TABLE `jumla_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `jumla_finder_links_terms6`
--
ALTER TABLE `jumla_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `jumla_finder_links_terms7`
--
ALTER TABLE `jumla_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `jumla_finder_links_terms8`
--
ALTER TABLE `jumla_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `jumla_finder_links_terms9`
--
ALTER TABLE `jumla_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `jumla_finder_links_termsa`
--
ALTER TABLE `jumla_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `jumla_finder_links_termsb`
--
ALTER TABLE `jumla_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `jumla_finder_links_termsc`
--
ALTER TABLE `jumla_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `jumla_finder_links_termsd`
--
ALTER TABLE `jumla_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `jumla_finder_links_termse`
--
ALTER TABLE `jumla_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `jumla_finder_links_termsf`
--
ALTER TABLE `jumla_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `jumla_finder_taxonomy`
--
ALTER TABLE `jumla_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `jumla_finder_taxonomy_map`
--
ALTER TABLE `jumla_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Индексы таблицы `jumla_finder_terms`
--
ALTER TABLE `jumla_finder_terms`
...
--
-- Индексы таблицы `jumla_finder_terms_common`
--
ALTER TABLE `jumla_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Индексы таблицы `jumla_finder_tokens`
--
ALTER TABLE `jumla_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Индексы таблицы `jumla_finder_tokens_aggregate`
--
ALTER TABLE `jumla_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Индексы таблицы `jumla_finder_types`
--
ALTER TABLE `jumla_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Индексы таблицы `jumla_languages`
--
ALTER TABLE `jumla_languages`
...
--
-- Индексы таблицы `jumla_menu`
--
ALTER TABLE `jumla_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `jumla_menu_types`
--
ALTER TABLE `jumla_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Индексы таблицы `jumla_messages`
--
ALTER TABLE `jumla_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Индексы таблицы `jumla_messages_cfg`
--
ALTER TABLE `jumla_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Индексы таблицы `jumla_modules`
--
ALTER TABLE `jumla_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `jumla_modules_menu`
--
ALTER TABLE `jumla_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Индексы таблицы `jumla_newsfeeds`
--
ALTER TABLE `jumla_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Индексы таблицы `jumla_overrider`
--
ALTER TABLE `jumla_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `jumla_postinstall_messages`
--
ALTER TABLE `jumla_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Индексы таблицы `jumla_privacy_consents`
--
ALTER TABLE `jumla_privacy_consents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Индексы таблицы `jumla_privacy_requests`
--
ALTER TABLE `jumla_privacy_requests`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `jumla_redirect_links`
--
ALTER TABLE `jumla_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Индексы таблицы `jumla_schemas`
--
ALTER TABLE `jumla_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Индексы таблицы `jumla_session`
--
ALTER TABLE `jumla_session`
...
--
-- Индексы таблицы `jumla_tags`
--
ALTER TABLE `jumla_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `jumla_template_styles`
--
ALTER TABLE `jumla_template_styles`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `jumla_ucm_base`
--
ALTER TABLE `jumla_ucm_base`
...
--
-- Индексы таблицы `jumla_ucm_content`
--
ALTER TABLE `jumla_ucm_content`
...
--
-- Индексы таблицы `jumla_ucm_history`
--
ALTER TABLE `jumla_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Индексы таблицы `jumla_updates`
--
ALTER TABLE `jumla_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Индексы таблицы `jumla_update_sites`
--
ALTER TABLE `jumla_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Индексы таблицы `jumla_update_sites_extensions`
--
ALTER TABLE `jumla_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Индексы таблицы `jumla_usergroups`
--
ALTER TABLE `jumla_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `jumla_users`
--
ALTER TABLE `jumla_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `jumla_user_keys`
--
ALTER TABLE `jumla_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Индексы таблицы `jumla_user_notes`
--
ALTER TABLE `jumla_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Индексы таблицы `jumla_user_profiles`
--
ALTER TABLE `jumla_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Индексы таблицы `jumla_user_usergroup_map`
--
ALTER TABLE `jumla_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Индексы таблицы `jumla_viewlevels`
--
ALTER TABLE `jumla_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT для таблицы `jumla_action_logs`
--
ALTER TABLE `jumla_action_logs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_action_logs_extensions`
--
ALTER TABLE `jumla_action_logs_extensions`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT для таблицы `jumla_action_log_config`
--
ALTER TABLE `jumla_action_log_config`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT для таблицы `jumla_assets`
--
ALTER TABLE `jumla_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT для таблицы `jumla_banners`
--
ALTER TABLE `jumla_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_banner_clients`
--
ALTER TABLE `jumla_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_categories`
--
ALTER TABLE `jumla_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT для таблицы `jumla_contact_details`
--
ALTER TABLE `jumla_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_content`
--
ALTER TABLE `jumla_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_content_types`
--
ALTER TABLE `jumla_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;

--
-- AUTO_INCREMENT для таблицы `jumla_extensions`
--
ALTER TABLE `jumla_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;

--
-- AUTO_INCREMENT для таблицы `jumla_fields`
--
ALTER TABLE `jumla_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_fields_groups`
--
ALTER TABLE `jumla_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_finder_filters`
--
ALTER TABLE `jumla_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_finder_links`
--
ALTER TABLE `jumla_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_finder_taxonomy`
--
ALTER TABLE `jumla_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `jumla_finder_terms`
--
ALTER TABLE `jumla_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_finder_types`
--
ALTER TABLE `jumla_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_languages`
--
ALTER TABLE `jumla_languages`
  MODIFY `lang_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `jumla_menu`
--
ALTER TABLE `jumla_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT для таблицы `jumla_menu_types`
--
ALTER TABLE `jumla_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `jumla_messages`
--
ALTER TABLE `jumla_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_modules`
--
ALTER TABLE `jumla_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;

--
-- AUTO_INCREMENT для таблицы `jumla_newsfeeds`
--
ALTER TABLE `jumla_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_overrider`
--
ALTER TABLE `jumla_overrider`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';

--
-- AUTO_INCREMENT для таблицы `jumla_postinstall_messages`
--
ALTER TABLE `jumla_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT для таблицы `jumla_privacy_consents`
--
ALTER TABLE `jumla_privacy_consents`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_privacy_requests`
--
ALTER TABLE `jumla_privacy_requests`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_redirect_links`
--
ALTER TABLE `jumla_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_tags`
--
ALTER TABLE `jumla_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `jumla_template_styles`
--
ALTER TABLE `jumla_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT для таблицы `jumla_ucm_content`
--
ALTER TABLE `jumla_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_ucm_history`
--
ALTER TABLE `jumla_ucm_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_updates`
--
ALTER TABLE `jumla_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_update_sites`
--
ALTER TABLE `jumla_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `jumla_usergroups`
--
ALTER TABLE `jumla_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT для таблицы `jumla_users`
--
ALTER TABLE `jumla_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=432;

--
-- AUTO_INCREMENT для таблицы `jumla_user_keys`
--
ALTER TABLE `jumla_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_user_notes`
--
ALTER TABLE `jumla_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `jumla_viewlevels`
--
ALTER TABLE `jumla_viewlevels`
